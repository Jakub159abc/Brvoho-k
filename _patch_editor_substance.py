...
p = pathlib.Path(r"c:\Users\jakub\Desktop\záloha\Brvohořík html\editor.html")
text = p.read_text(encoding="utf-8")

old_start = "        function substanceFilterScript() {"
marker = "        function substanceExtraCss()"
idx = text.find(old_start)
if idx == -1:
    raise SystemExit("start not found")
idx2 = text.find(marker, idx)
if idx2 == -1:
...
text2 = text[:idx] + new_fn + text[idx2:]
